...
export default function ControlPanel() {
    ...
    return (
        <div className={(isPanelOpen ? s.active + " " : "") + s.wrapper}>
            <div className={s.close} onClick={() => setIsPanelOpen(false)}>
                🗙
            </div>
            <Toast ref={toastRef}/>
            <Dialog visible={dialogVisible} modal header={"Generate Image using AI"} footer={footerContent}
                ...
                <SavePopup>
                    <div>
                        ...
                        <input type="text" onKeyDown={() => setIsWriting(true)} onKeyUp={() => setIsWriting(false)}
                               ref={promptRef}/>
                    </div>
                </SavePopup>
            </Dialog>
            <div className={s.containerInner}>
                ...
                >
                    <DecalManager setIsPanelOpen={setIsPanelOpen}/>
                </Card>
                ...
                <Card
                    ...
                    style={{gridColumn: 'span 2'}}
                >
                    <TextEditor setDecalPath={setDecalPath} setIsPanelOpen={setIsPanelOpen}/>
                </Card>
            </div>
        </div>
    )
