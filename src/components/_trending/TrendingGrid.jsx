...
export default function TrendingGrid() {
	...
	return (
		<>
			...
			<HeaderType content={"Trendy Caps"} icon={<PiBaseballCap/>}/>
			<STrendingContainer>
				<Carousel value={trendingCardsCaps} numVisible={3} numScroll={2} itemTemplate={CarouselCard}/>
			</STrendingContainer>
		</>
	)
}
