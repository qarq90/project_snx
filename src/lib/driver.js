	...
	const driverObj = driver({
		...
		steps: [
			...
			},
			{
				...
				popover: {
					title: 'Logout',
					description: 'Click here to securely log out of your account. When you log out, you will be signed out of all active sessions and redirected to the login page.'
				}
			},
			{
				element: '#theme-link',
				popover: {
					title: 'Theme',
					description: 'Toggle between light and dark themes by clicking here. Customize your browsing experience with our theme switcher, offering a comfortable viewing mode regardless of lighting conditions.'
				}
			},
			{
				element: '#help-button',
